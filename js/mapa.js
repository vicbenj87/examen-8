/* ==========================================================================
   ...
   Las coordenadas están en porcentaje sobre la imagen original (1024 × 642),
   así el mapa se adapta a cualquier tamaño de pantalla.
   ========================================================================== */
...
EX.Mapa = (function () {
  ...
  var ZONAS = [
    { nombre: 'Canaán',      x: 31.5, y: 45.5, pista: 'Entre el Mediterráneo y el Jordán' },
    { nombre: 'Filistea',    x: 26.3, y: 65.5, pista: 'Llanura costera del suroeste' },
    { nombre: 'Amón',        x: 37.5, y: 54.5, pista: 'Al este del Jordán, al norte de Moab' },
    { nombre: 'Moab',        x: 35.5, y: 68.0, pista: 'Al este del mar Muerto' },
    { nombre: 'Madián',      x: 33.9, y: 86.8, pista: 'Al este del golfo de Aqaba' },
    { nombre: 'Mesopotamia', x: 55.3, y: 16.8, pista: 'Entre el Tigris y el Éufrates' }
  ];
