/* ==========================================================================
   ...
   (origen "null", donde fetch se topa con CORS).
   Si no hay URL configurada, todo se guarda en este dispositivo.
   ========================================================================== */
...
EX.Sheets = (function () {
  ...
  function registrarInicio(nombre, apellido) {
    var id = 'rc8-' + Date.now().toString(36) + '-' + Math.random().toString(36).slice(2, 7);
